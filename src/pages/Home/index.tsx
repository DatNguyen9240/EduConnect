  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex flex-col items-center justify-center px-6 py-12 relative">
      ...
      <p className="text-lg text-gray-700 text-center max-w-xl mb-6">
        Nền tảng kết nối số thông minh giữa <strong>phụ huynh</strong>,{" "}
        <strong>giáo viên</strong>,<strong> học sinh</strong> và{" "}
        <strong>ban giám hiệu</strong>, giúp theo dõi và nâng cao chất lượng
        giáo dục trung học.
      </p>
